...
# Initialize camera
cam = cv2.VideoCapture(0, cv2.CAP_DSHOW)  # Use DirectShow backend for better compatibility
cam.set(3, cam_w)
cam.set(4, cam_h)
...
while cam.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand, handedness_info in zip(results.multi_hand_landmarks, results.multi_handedness):
            ...
            mp_drawing.draw_landmarks(frame, hand, mp_hands.HAND_CONNECTIONS)  # Fixed typo
